...
Deno.serve(withAdminActivity("verify-gcash-receipt", async (req) => {
  ...
  try {
    ...
    let readingLayout = "gcash_unknown";
    let ocrText = "";
    let ocrOriginalText = "";
