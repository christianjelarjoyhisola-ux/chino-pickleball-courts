...
begin
 ...
 if p_enabled then
  update public.courts set promo_enabled=true,promo_rate=p_rate,promo_start_date=p_start,promo_end_date=p_end;
 else
  update public.courts set promo_enabled=false;
 end if;
